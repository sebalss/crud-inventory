                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/{{$suratjalan_barangkeluar -> id}}/inputdatabarangkeluar_create">
                                    {{csrf_field()}}
                                    <div class="form-group">   
                                            <label for="inputText3" class="col-form-label">No. Surat Jalan</label>
                                            <input id="inputText3" readonly="" name="suratkeluar_id" type="text" class="form-control" value="{{$suratjalan_barangkeluar -> id}}">
                                    </div>
                                    <div class="form-group">   
                                            <label for="inputText3" class="col-form-label">Nama Penerima</label>
                                            <input id="inputText3" readonly="" type="text" class="form-control" value="{{$suratjalan_barangkeluar -> nama_penerima}}">
                                    </div>
                                    <!-- <div class="form-group">
                                            <label hidden>Tanggal</label>
                                            <input type="date" hidden class="form-control date-inputmask" name="tanggal" id="datepicker" placeholder="" value="{{$suratjalan_barangkeluar -> tanggal}}">
                                    </div>
                                    <div class="form-group">
                                            <label for="inputText3" hidden class="col-form-label">Supplier</label>
                                            <input id="inputText3" hidden name="supplier" type="text" class="form-control" value="{{$suratjalan_barangkeluar -> nama_penerima}}">
                                    </div>
                                    <div class="form-group">
                                            <label for="exampleFormControlTextarea1" hidden>Catatan</label>
                                            <textarea class="form-control" hidden name="catatan" id="exampleFormControlTextarea1" rows="3">{{$suratjalan_barangkeluar -> catatan}}</textarea>
                                    </div> -->
                                    <div class="form-group">
