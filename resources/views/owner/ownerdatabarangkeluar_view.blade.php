...
@section('content')
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header" id="top">
                            <h2 class="pageheader-title">Cetak Laporan Data Barang Keluar</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Cari Data Barang Keluar berdasarkan Tanggal</h5>
                            <div class="card-body">
                                    <form action="/cari_ownerlaporanbarangkeluar" method="POST" class="form-inline">
                                        {{csrf_field()}}
